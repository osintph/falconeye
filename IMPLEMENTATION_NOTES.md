...
## 10. nginx vhost (two-phase deploy)
...
## 14. v0.2 acceptance checklist (operator-facing)
...
## 15. Build sequence for Claude Code (v0.2 additions)
...
16. systemd units for shodan; `scripts/run.sh` updated (Step 9)
17. Documentation update (Step 10); robots.txt + sitemap.xml in SSG (Adjustment 8)
