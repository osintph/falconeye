...
# Blocked ranges: RFC 1918, loopback, link-local (OVH metadata), reserved
BLOCKED_RANGES = [
...
def validate_url(url: str) -> tuple[bool, str]:
    ...
    # Block raw IP submissions in addition to resolved IPs
    try:
        ...
        pass  # hostname is a domain, not a raw IP — continue to resolve
